...
//云台转轴中心到发射最大初速度点的距离
#define DISTANCE_STATIC 0.05148f
//枪管pitch歪(相较于正确安装的误差)
...
//装甲板选择的速度阈值
#define SELECT_ARMOR_V_YAW_THRES 2.0f
//延时等待
...
// 空气阻力系数简化版
#define AIR_K1 0.17
#define AIR_K1_GROUND 0.15
#define AIR_K1_UP 0.09
#elif (BULLET_TYPE == 1)
// 空气阻力系数简化版
...
//初始设定弹速
#define BEGIN_SET_BULLET_SPEED 23.4f
...
typedef struct
{
    ...
    uint8_t rx_buf[50];
    // 发送给视觉结构体
    vision_send_packet_t vision_send_packet;
    // 接收到视觉结构体
