...
// 需手动修改
#define GxOFFSET 0.00325101218
#define GyOFFSET 0.00109366805
#define GzOFFSET 0.00195244106

#define AxOFFSET -0.0740925074
#define AyOFFSET -0.122237608
#define AzOFFSET 0.0f//Z轴先不减去零飘值，因为零飘值包含重力加速度的值
#define gNORM 9.57129002
