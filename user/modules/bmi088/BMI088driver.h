...
// 需手动修改
#define GxOFFSET -0.00138057536
#define GyOFFSET 0.00457250467
#define GzOFFSET -0.00289661274

#define AxOFFSET 0.21633172
#define AyOFFSET -0.147072643
#define AzOFFSET 0.0f//Z轴先不减去零飘值，因为零飘值包含重力加速度的值
#define gNORM 9.62578297
