...
// 需手动修改
#define GxOFFSET 0.00875769835
#define GyOFFSET 0.000466229918
#define GzOFFSET 0.00138785539

#define AxOFFSET 0.286017865
#define AyOFFSET -0.0429946259
#define AzOFFSET 0.0f//Z轴先不减去零飘值，因为零飘值包含重力加速度的值
#define gNORM 9.5799818
