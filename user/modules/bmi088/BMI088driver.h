...
// 需手动修改
#define GxOFFSET 0.00406348053
#define GyOFFSET -0.00290460745
#define GzOFFSET 0.00216194219

#define AxOFFSET 0.176280469
#define AyOFFSET -0.277026355
#define AzOFFSET 0.0f//Z轴先不减去零飘值，因为零飘值包含重力加速度的值
#define gNORM 9.58364296
