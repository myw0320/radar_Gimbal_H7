...
// 需手动修改
#define GxOFFSET -0.00111142034
#define GyOFFSET -0.00111142034
#define GzOFFSET 0.00322703784

#define AxOFFSET 0.334493846
#define AyOFFSET -0.468787879
#define AzOFFSET 0.0f//Z轴先不减去零飘值，因为零飘值包含重力加速度的值
#define gNORM 9.63061905
